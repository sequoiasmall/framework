      ...
      <div class="grid-x grid-padding-x">
        <div class="large-12 cell">
          <div class="primary callout">
            <h3>QUICK SEARCH </h3>
            <p>Get to know the history and achievements of you favorite artists!</p>
            <p>To navigate select an artist or group!</p>
            <div class="grid-x grid-padding-x">
              <div class="large-4 medium-4 cell">
                <p><a href="https://get.foundation/docs">BTS</a><br />The world's most famous boygroup Bangtan Sonyeondan, better known as BTS, consists of 7 members.</p>
              </div>
              <div class="large-4 medium-4 cell">
                <p><a href="http://zurb.com/university/code-skills">TomorrowxTogether</a><br />Boy group Tomorrow x Together, also known as TXT, consists of 5 members who are deemed as Kpop's 4th generation "It Boys".</p>
              </div>
              <div class="large-4 medium-4 cell">
